...
export type VolunteerSectionSchema = {
  /**
   * e.g. Facebook
   */
  organization?: string;
...
export type AwardsSectionSchema = {
  /**
...
export type PublicationsSectionSchema = {
  /**
...
export type SkillsSectionSchema = {
  /**
   * e.g. Web Development
   */
  name?: string;
...
export type LanguagesSectionSchema = {
  /**
   * e.g. English, Spanish
   */
  language?: string;
...
export type InterestsSectionSchema = {
  /**
   * e.g. Philosophy
   */
  name?: string;
...
export type ReferencesSectionSchema = {
  /**
   * e.g. Timothy Cook
   */
  name?: string;
...
export type ProjectsSectionSchema = {
  /**
   * e.g. The World Wide Web
   */
  name?: string;
